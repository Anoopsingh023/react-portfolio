      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 text-[#8245ec] leading-tight">
            ...
            <Typewriter
              words={["Fullstack Developer", "MERN Developer", "Python Developer"]}
              loop={0} // 0 = infinite
              cursor
              cursorStyle="|"
              typeSpeed={100}
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            production-ready projects and optimizing performance for better user
            experience.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/drive/u/0/folders/1keeh8v8Cr5zJeR-VGrWxh0aoo98LrfYu"
            target="_blank"
